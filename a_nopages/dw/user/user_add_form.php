...
<form name="user_add_form" id="user_add" action="user/user_add_insert.php" method="post">
	<table cellspacing="0" cellpadding="0" id="user_add_table">
		...
		<tr>
			...
			<td>
				<div>
                    <input type="button" value="주소찾기" id="search_button"/>
					<input type="text" name="address" id="address" class="user_add_address postcodify_address" placeholder="우편번호" onclick="addressAPI();">
				</div>
			</td>
		</tr>
		<tr>
