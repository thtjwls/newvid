...
<div class="in_contents_wrap">
    <body>
        <div class="body">
            ...
            -->
            <!-- 커스터마이징 -->
            <form name="tx_editor_form" id="tx_editor_form" action="./lib/page1_insert.php" method="post" accept-charset="utf-8">
                <div id="tx_trex_subject_title" class="tx_trex_subject_title">
                    <table cellpadding="1" cellspacing="1">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tx_trex_cate" id="tx_trex_cate" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                ...
                <?
                $sql="select content from test_tbl where idx='20'";
