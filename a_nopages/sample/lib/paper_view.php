...
<?
	...
	$sql="select * from pa_paper where idx='$idx'";
...
?>
<div class="body" id="pa_view_div_content">
    <!-- 커스터마이징 -->
    <form name="tx_editor_form" id="tx_editor_form" method="post" accept-charset="utf-8">
        <div id="tx_trex_subject_title" class="tx_trex_subject_title">
            ...
            <table id="tx_save_menu" width="60%;">
                <tr>
                    <th id='paper_save'>
                        내문서로 저장
                    </th>
        ...
        <div class="approve_line">
            <div id="level_8" class="approve_member" <? if($app8 != 0){echo "style='display:block'";} ?>>
            ...
            <div id="level_7" class="approve_member" <? if($app7 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            본부장
            ...
            <div id="level_6" class="approve_member" <? if($app6 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            국장
            ...
            <div id="level_5" class="approve_member" <? if($app5 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            부장
            ...
            <div id="level_4" class="approve_member" <? if($app4 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            차장
            ...
            <div id="level_3" class="approve_member" <? if($app3 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            과장
            ...
            <div id="level_2" class="approve_member" <? if($app2 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            대리
            ...
            <div id="level_1" class="approve_member" <? if($app1 != 0){echo "style='display:block'";} ?>>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>
                            사원
        ...
        <!--<input type="hidden" name="content" id="idx_content" value="<?=$content?>" />-->
        <textarea id="idx_contents_source" style="display:none" ;>
            <?=$content?>
        </textarea>
        <script type="text/javascript">
            function test_content() {
                ...
                Editor.modify({
                    ...
                    "content": document.getElementById("idx_contents_source") /* 내용 문자열, 주어진 필드(textarea) 엘리먼트 */
                });
            }
        </script>
        <!-- 커스터마이징 끝-->
                ...
                <div class="tx-toolbar-boundary">
                    ...
                    <ul class="tx-bar tx-bar-left">
                        <li class="tx-list">
                            ...
                            <div id="tx_tablevalign_menu" class="tx-cellvalign-menu tx-menu tx-cellvalign" unselectable="on"></div>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="tx-attach-main">
                            ...
                            <ul class="tx-attach-top">
                                ...
                                <li id="tx_attach_size" class="tx-attach-size">
                                    파일:
                                    <span id="tx_attach_up_size" class="tx-attach-size-up"></span>/
...
<!-- 새로만듬
        <div>
            ...
            <button onclick='saveContent()'>SAMPLE - submit contents</button>
...
<!-- test load contents <div><button onclick='loadContent()'>SAMPLE - load contents to editor</button></div>-->
