...
<div class="body">
    ...
    <form name="tx_editor_form" id="tx_editor_form" method="post" accept-charset="utf-8">
        <div id="tx_trex_subject_title" class="tx_trex_subject_title">
            <table cellpadding="1" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <input type="text" name="tx_trex_subject" id="tx_trex_subject" />
                    </td>
                </tr>
                <tr>
                    <th>
		...
		<div class="approve_line">
			<div id="level_8" class="approve_member">
			...
			<div id="level_7" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							본부장
			...
			<div id="level_6" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							국장
			...
			<div id="level_5" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							부장
			...
			<div id="level_4" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							차장
			...
			<div id="level_3" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							과장
			...
			<div id="level_2" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							대리
			...
			<div id="level_1" class="approve_member">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>
							사원
