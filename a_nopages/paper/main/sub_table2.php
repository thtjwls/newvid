...
{
		location.replace("sub_table2.php?flag=1&part=" + part);
}
</script>
...
<table width='600' border=0 cellspacing=0 cellpadding=0 bgcolor=f0f0f0  class=bts style='border=top:none;'>
 ...
 <td align=center width=70 class=bts style='border-top:none;' bgcolor=F0F0D8>상위 결재인</td>

  
 <td width=140 align=left class=mid><img src=./image/check1.gif align=absmiddle>
 <select name='group1' onchange='reload(window.document.sub_table2.group1.options[selectedIndex].value);' value=<?echo$part;?>>
