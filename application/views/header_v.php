...
<body style="position: relative;">
    <header class="header clearfix">
        ...
        <h1>
            <a href="/" class="logo">
                <img src="/images/header_logo.png" alt="header로고" height="100%;">
            </a>
        </h1>
        <!-- end logo image -->
        <!-- gnb-navigation -->
                        ...
                        <div class="sub_menu__item">
                            <div class="sub_menu__container clearfix">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="/blog/culture">문화</a>
                                    </li>
                                    <li>
                                        <a href="/blog/lecture">강의</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <!-- end my-menu navigation -->
        <!--
        <div class="sub_menu">
            <div class="sub_menu__item01">

            </div>
            <div class="sub_menu__item02"></div>
            <div class="sub_menu__item03"></div>
            <div class="sub_menu__item04"></div>
            <div class="sub_menu__item05"></div>
        </div>
        -->
    </header>
